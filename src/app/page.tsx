        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-400">Resident portal</p>
            </div>
          </div>
          ...
          <button
            ...
            className="relative grid size-11 place-items-center rounded-xl border border-slate-700 text-slate-200 transition hover:border-slate-500 hover:bg-slate-900"
          >
            <BellIcon />
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-28 pt-6 sm:px-6 sm:pb-10">
        <section aria-labelledby="resident-welcome">
          ...
          <div className="mt-2 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <button
              type="button"
              className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 font-bold text-slate-950 shadow-sm transition hover:bg-emerald-400 sm:w-auto"
            >
              <PlusIcon />
              Create access pass
            </button>
        ...
        >
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Entries this week</p>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Denied attempts</p>
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-emerald-900">
            Temporary passes should only be created for expected visitors. Never
            share permanent gate credentials through text messages or delivery
            instructions.
          </p>
        </section>
      </main>
